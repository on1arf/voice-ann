...
void * dvframe_crc (unsigned char * dvstartframe) {
// this function sets the CRC-values (the last 2 bytes) of a DSTAR digital
// voice frame. It calculates this value on byte 15 up to 53 of the frame
// (fields flag1, flag2, flag3, destination, departure, companion, own1
// and own2)
uint16_t m_crc;
...
// loop throu all bytes 15 up to 53 of the header

for (loop=15; loop <= 53; loop++) {
...
dvstartframe[54] = (m_crc >> 8) & 0xFF;
dvstartframe[55] = (m_crc >> 0) & 0xFF;
